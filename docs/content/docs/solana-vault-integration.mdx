...
<div style="background: #f0f9ff; border: 1px solid #0ea5e9; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
  <strong>🎉 New in v1.9.7:</strong> Added <code>boringQueueStatuses</code> function for tracking withdraw request status with automatic filtering and performance optimization.
</div>
