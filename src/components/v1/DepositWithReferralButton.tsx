// src/components/v1/DepositWithReferralButton.tsx
        ...
        <ModalContent {...modalContentProps}>
          ...
          <ModalBody {...modalBodyProps}>
            ...
            <Flex justifyContent="space-between" mt={2}>
              ...
              <Button
                mt={4}
                // Signer is the referral address
                onClick={() => deposit(signer!, depositAmount, selectedToken, signer!.address)}
              ...
              <Button
                mt={4}
                // Signer is the referral address
                onClick={() => depositWithPermit(signer!, depositAmount, selectedToken, undefined, signer!.address)}
                isDisabled={
                  !signer ||
                  !depositAmount ||
                  parseFloat(depositAmount || "0") <= 0 ||
